...
if(isset($_SESSION["id_u"])){
	if($_SESSION["statut"]==1 && isset($_GET["id_produit"])){
		include("fonctions_client.php");
		$con=connect_sqli(); 
		$con->set_charset("utf8");
		include("ajout_produitclient.php");
		menu("Produits",$nbreprod,$_SESSION["pseudo"],"produits");
		$idp=$_GET["id_produit"];
		$sql="SELECT * from produits p, utilisateurs u  WHERE p.id_produit=$idp and u.id_u=p.id_vendeur";
